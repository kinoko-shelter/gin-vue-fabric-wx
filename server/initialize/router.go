...
func Routers() *gin.Engine {
	...
	{
		RoadsRouter := router.RouterGroupApp.Roads
		RoadsRouter.InitRoadsRouter(PrivateGroup)

	}
	{
		ChargingStationsRouter := router.RouterGroupApp.ChargingStations
		ChargingStationsRouter.InitChargingStationsRouter(PrivateGroup)
	}
	{
		ChargingStatusRouter := router.RouterGroupApp.ChargingStatus
		ChargingStatusRouter.InitChargingStatusRouter(PrivateGroup)
	}
	{

	}
	{
		VehiclesRouter := router.RouterGroupApp.Vehicles
		VehiclesRouter.InitVehiclesinfoRouter(PrivateGroup)
		VehiclesRouter.InitCarinfoRouter(PrivateGroup)
	}
	{

	}
	{
		cmapRouter := router.RouterGroupApp.Cmap
		cmapRouter.InitCarmapRouter(PrivateGroup)
		cmapRouter.InitCmapinfoRouter(PrivateGroup)
	}
