...
func RegisterTables() {
	...
	err := db.AutoMigrate(
		...
		example.ExaFileUploadAndDownload{}, Roads.Roads{}, ChargingStations.ChargingStations{}, ChargingStatus.ChargingStatus{}, Vehicles.Vehiclesinfo{}, Vehicles.Carinfo{}, cmap.Carmap{}, cmap.Cmapinfo{},
	)
	if err != nil {
