  ...
  <div class="ReclaimMileage-box">
    ...
    <div class="ReclaimMileage-box-data">
      <div class="ReclaimMileage-box-data-left">
        <div>MA</div>
        <div class="number">19,228 <span>-10% ↓</span></div>
        <div>昨日: 5,928</div>
      </div>
      <div class="ReclaimMileage-box-data-right">
        <div>DI</div>
        <div class="number">23,560 <span style="color: #D3B379" >-15% ↓</span></div>
        <div>昨日: 10,980</div>
      </div>
    </div>
    ...
    series: [
      {
        ...
        data: [2200, 1820, 1910, 2340, 2900, 3300, 3100, 2010, 1540, 1900, 3300, 4100]
      },
    ]
  })
}
