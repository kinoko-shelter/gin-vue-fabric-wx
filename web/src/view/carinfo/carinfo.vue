<template>
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束日期" :disabled-date="time=> searchInfo.startCreatedAt ? time.getTime() < searchInfo.startCreatedAt.getTime() : false"></el-date-picker>
        ...
        <el-form-item label="车辆日前预测里程" prop="mileagePre">
         <el-input v-model="searchInfo.mileagePre" placeholder="搜索条件" />

        </el-form-item>
        <el-form-item label="车辆位置x" prop="carLocationx">
         <el-input v-model="searchInfo.carLocationx" placeholder="搜索条件" />

        </el-form-item>
        <el-form-item label="车辆位置y" prop="carLocationy">
         <el-input v-model="searchInfo.carLocationy" placeholder="搜索条件" />
        ...
        <el-form-item label="累计行驶里程" prop="totalMileage">
         <el-input v-model="searchInfo.totalMileage" placeholder="搜索条件" />
        ...
        <el-form-item label="当前状态" prop="currentState">
         <el-input v-model="searchInfo.currentState" placeholder="搜索条件" />
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="车辆日前预测里程" prop="mileagePre" width="120" />
        <el-table-column align="left" label="车辆位置x" prop="carLocationx" width="120" />
        <el-table-column align="left" label="车辆位置y" prop="carLocationy" width="120" />
        <el-table-column align="left" label="电量" prop="soc" width="120" />
        <el-table-column align="left" label="累计行驶里程" prop="totalMileage" width="120" />
        ...
        <el-table-column align="left" label="车辆类型" prop="type" width="120" />
        <el-table-column align="left" label="当前状态" prop="currentState" width="120" />
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
            ...
            <el-button type="primary" link icon="edit" class="table-button" @click="updateCarinfoFunc(scope.row)">变更</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" :title="type==='create'?'添加':'修改'" destroy-on-close>
      <el-scrollbar height="500px">
          <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="车辆日前预测里程:"  prop="mileagePre" >
              <el-input v-model="formData.mileagePre" :clearable="true"  placeholder="请输入车辆日前预测里程" />
            </el-form-item>
            <el-form-item label="车辆位置x:"  prop="carLocationx" >
              <el-input v-model="formData.carLocationx" :clearable="true"  placeholder="请输入车辆位置x" />
            </el-form-item>
            <el-form-item label="车辆位置y:"  prop="carLocationy" >
              <el-input v-model="formData.carLocationy" :clearable="true"  placeholder="请输入车辆位置y" />
            </el-form-item>
            <el-form-item label="电量:"  prop="soc" >
              <el-input v-model="formData.soc" :clearable="true"  placeholder="请输入电量" />
            </el-form-item>
            <el-form-item label="累计行驶里程:"  prop="totalMileage" >
              <el-input v-model="formData.totalMileage" :clearable="true"  placeholder="请输入累计行驶里程" />
            </el-form-item>
            ...
            <el-form-item label="车辆类型:"  prop="type" >
              <el-input v-model="formData.type" :clearable="true"  placeholder="请输入车辆类型" />
            </el-form-item>
            <el-form-item label="当前状态:"  prop="currentState" >
              <el-input v-model="formData.currentState" :clearable="true"  placeholder="请输入当前状态" />
            </el-form-item>
          </el-form>
      </el-scrollbar>
      <template #footer>
      ...
      <el-scrollbar height="550px">
        <el-descriptions :column="1" border>
                ...
                <el-descriptions-item label="车辆位置x">
                        {{ formData.carLocationx }}
                </el-descriptions-item>
                <el-descriptions-item label="车辆位置y">
                        {{ formData.carLocationy }}
                </el-descriptions-item>
...
const getTableData = async() => {
  const table = await getCarinfoList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
...
const onDelete = async() => {
      ...
      const res = await deleteCarinfoByIds({ IDs })
      if (res.code === 0) {
        ElMessage({
          type: 'success',
          message: '删除成功'
...
// 更新行
const updateCarinfoFunc = async(row) => {
    const res = await findCarinfo({ ID: row.ID })
    type.value = 'update'
    if (res.code === 0) {
...
// 删除行
const deleteCarinfoFunc = async (row) => {
    const res = await deleteCarinfo({ ID: row.ID })
    if (res.code === 0) {
        ElMessage({
                type: 'success',
                message: '删除成功'
